...
void insertAtPositon(Node* &tail, Node* &head, int position, int d){
    ...
    //Creating a node for 'd' middle value
...
int main(){
 ...
 insertAtHead(tail,head, 11);
    ...
    insertAtPositon(tail, head, 2, 100);
    print(head);

    insertAtPositon(tail, head, 1, 101);
    print(head);

    insertAtPositon(tail, head, 7, 102);
    print(head);
